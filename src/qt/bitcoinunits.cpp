...
QString BitcoinUnits::name(int unit)
{
    ...
    case uBTC: return QString("uDSC");
    //case nBTC: return QString::fromUtf8("nBNS"); //Don't support nano BNS yet.
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Uka (1 : 1)");
    case mBTC: return QString("miliUka (1 / 1,000)");
    case uBTC: return QString("microUka (1 / 1,000,000)");
    //case nBTC: return QString("nanoUka (1 / 1,000,000,000)"); //Don't support nano BNS yet.
    default: return QString("???");
    }
}
...
//TODO: Update based on max coins
