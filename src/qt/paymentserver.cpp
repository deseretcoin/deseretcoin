...
const QString BITCOIN_IPC_PREFIX("deseret:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click deseret: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start deseret: click-to-pay handler");
    else
...
{
    // clicking on deseret: URLs creates FileOpen events on the Mac:
