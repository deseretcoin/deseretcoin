...
// Copyright (c) 2013 DeseretCoin developers
...
const string strMessageMagic = "DeseretCoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if (nHeight < 101) {nSubsidy = 990000 * COIN;}
...
static const int64 nTargetTimespan = 45; // 1 minutes
static const int64 nTargetSpacing = 25; // 30 seconds
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("DeseretCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("DeseretCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("DeseretCoinMiner started\n");
    ...
    try { loop {
        ...
        printf("Running DeseretCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("DeseretCoinMiner terminated\n");
        throw;
    }
}
